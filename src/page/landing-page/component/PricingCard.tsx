...
export default function PricingCard({plan, price, features, isPopular}: {
    ...
    return (
        <div className="p-4 xl:w-1/4 md:w-1/2 w-full">
            <div className={"h-full p-6 rounded-lg border-2 flex flex-col relative overflow-hidden " + borderColor}>
                {isPopular && <span
                    className="bg-blue-600 text-white px-3 py-1 tracking-widest text-xs absolute right-0 top-0 rounded-bl">POPULAR</span>}
                <h2 className="text-sm tracking-widest text-gray-400 title-font mb-1 font-medium text-left uppercase">{plan}</h2>
