import * as PriceInformation from './../constant/price.ts';

export default function Pricing() {
    return (
        <section className="text-gray-700 dark:text-gray-400 body-font overflow-hidden">
                ...
                <div className="flex flex-wrap -m-4">
                    <div className="p-4 xl:w-1/4 md:w-1/3 w-full">
                        <div className="h-full p-6 rounded-lg border-2 border-gray-700 flex flex-col relative overflow-hidden">
                            <h2 className="text-sm tracking-widest text-gray-400 title-font mb-1 font-medium">{PriceInformation.BASIC_PLAN.title}</h2>
                            <h1 className="text-5xl text-white leading-none flex items-center pb-4 mb-4 border-b border-gray-800">
                                <span>${PriceInformation.BASIC_PLAN.price}</span>
                                <span className="text-lg ml-1 font-normal text-gray-400">/mensualmente</span>
                            </h1>
                            {
                                PriceInformation.BASIC_PLAN.features.map((feature, index) => {
                                    return (
